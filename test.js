var App = React.createClass({
    ...
    render: function() {
        if(this.state.data.results) {
            ...
            $(".seachResults ul").html('');
            $.each(this.state.data.results,function(key,value){
                $(".seachResults ul").append('<li><img src="https://image.tmdb.org/t/p/w500'+value.poster_path+'" width="50" />'+value.original_title+'</li>');
            })
        }
            ...
            <div id="hero" className="Hero" style={{backgroundImage: 'url(https://images.alphacoders.com/633/633643.jpg)'}}>
                <div className="content">
                    ...
                    <div className="button-wrapper">
                        <HeroButton primary={true} text="Şimdi izle" />
                        <HeroButton primary={false} text="+ Listeme ekle" />
                    </div>
                </div>
